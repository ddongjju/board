 ...
 */
@WebServlet("/boardDownInsert")
@MultipartConfig
public class BoardDownInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(BoardDownInsertServlet.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/board/insertDownboard.jsp").forward(request, response);
	}
